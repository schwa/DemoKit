...
struct DemoView4: DemoView {
    static var metadata = DemoMetadata(type: Self.self, description: "This is a demo view 4", longDescription: "Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.", group: "Group A")
    init() {}
    var body: some View {
        Text("Demo View 4")
            .border(Color.red)
